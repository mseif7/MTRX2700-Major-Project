...
void main(void) {
  ...
  if(vertical_distance<=30||vertical_distance>0){
    box_quantity = 3;
  } 
  else if(vertical_distance<=40||vertical_distance>30){
    box_quantity = 2;
  } 
  else if(vertical_distance<=50||vertical_distance>40){
    box_quantity = 1;
  }
  else{
    box_quantity = 0;
